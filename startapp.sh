...
#no-gui
#exec chromium freebitco.in --headless=new --remote-allow-origins=* --user-data-dir=/config/1 --no-sandbox --disable-dev-shm-usage --disable-gpu --disable-software-rasterizer --disable-logging --disable-site-isolation-trials 

#yes-gui
exec chromium freebitco.in --user-data-dir=/config/1 --no-sandbox --disable-dev-shm-usage --disable-gpu --disable-software-rasterizer --disable-logging --disable-site-isolation-trials 


#working without click tampemonkey icon --user-data-dir=/config/1 --no-sandbox --disable-dev-shm-usage --disable-gpu --disable-software-rasterizer --disable-logging --disable-site-isolation-trials

#freebitco.in --headless=new --remote-allow-origins=*
#--allow-running-insecure-content --disable-add-to-shelf --disable-gpu --disable-software-rasterizer --disable-background-networking --disable-background-timer-throttling --disable-backgrounding-occluded-windows --disable-breakpad --disable-checker-imaging --disable-client-side-phishing-detection --disable-component-extensions-with-background-pages --disable-datasaver-prompt --disable-desktop-notifications --disable-dev-shm-usage --disable-domain-reliability --disable-hang-monitor --disable-infobars --disable-ipc-flooding-protection --disable-notifications --disable-popup-blocking --disable-prompt-on-repost --disable-renderer-backgrounding --disable-setuid-sandbox --disable-site-isolation-trials --disable-sync --disable-web-security --ignore-certificate-errors --disable-logging --metrics-recording-only --mute-audio --no-default-browser-check --no-first-run --test-type --use-mock-keychain
#https://textdoc.co/xCPEGStu9bFyL7dO --headless=new --remote-allow-origins=*


#https://textdoc.co/xCPEGStu9bFyL7dO
